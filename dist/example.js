...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Types = PS["Types"];                 
  var AddedTodo = (function () {
      function AddedTodo(value0) {
          this.value0 = value0;
      };
      AddedTodo.create = function (value0) {
          return new AddedTodo(value0);
      };
      return AddedTodo;
  })();
  var UpdatedName = (function () {
      function UpdatedName(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdatedName.create = function (value0) {
          return function (value1) {
              return new UpdatedName(value0, value1);
          };
      };
      return UpdatedName;
  })();
  var NewTodo = (function () {
      function NewTodo(value0) {
          this.value0 = value0;
      };
      NewTodo.create = function (value0) {
          return new NewTodo(value0);
      };
      return NewTodo;
  })();
  var addTodoForm = (function () {
      var render = function (currentName) {
          var nameInput = Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.placeholder("Task Name"), Halogen_HTML_Properties.value(currentName), Halogen_HTML_Events.onValueChange(Halogen_HTML_Events.input(UpdatedName.create)) ]);
          var addButton = Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("Add Task"), Halogen_HTML_Properties.disabled(Data_String_CodePoints.length(currentName) === 0), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddedTodo.create)) ])([ Halogen_HTML_Core.text("Add Task") ]);
          return Halogen_HTML_Elements.div([  ])([ nameInput, addButton ]);
      };
      var $$eval = function (v) {
          if (v instanceof AddedTodo) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(""))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new NewTodo({
                          todoName: v1
                      })))(function () {
          ...
          throw new Error("Failed pattern match at TodoForm line 48, column 12 - line 56, column 14: " + [ v.constructor.name ]);
      };
  ...
  exports["AddedTodo"] = AddedTodo;
  exports["UpdatedName"] = UpdatedName;
  exports["addTodoForm"] = addTodoForm;
})(PS["TodoForm"] = PS["TodoForm"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var TodoForm = PS["TodoForm"];
  var Types = PS["Types"];                 
  var FinishedTodo = (function () {
      function FinishedTodo(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      FinishedTodo.create = function (value0) {
          return function (value1) {
              return new FinishedTodo(value0, value1);
          };
      };
      return FinishedTodo;
  })();
  var HandleNewTask = (function () {
      function HandleNewTask(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleNewTask.create = function (value0) {
          return function (value1) {
              return new HandleNewTask(value0, value1);
          };
      };
      return HandleNewTask;
  })();
  var todoList = function (dictApplicative) {
      var renderTask = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text(v.todoName) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(FinishedTodo.create(v))) ])([ Halogen_HTML_Core.text("Finish") ]) ]);
      };
      var formSlot = Halogen_HTML.slot("Add Todo Form")(TodoForm.addTodoForm)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleNewTask.create));
      var render = function (todos) {
          var taskList = Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderTask)(todos));
          return Halogen_HTML_Elements.div_([ taskList, formSlot ]);
      };
      var $$eval = function (v) {
          if (v instanceof FinishedTodo) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Array.filter(function (v2) {
                      return Data_Eq.notEq(Types.eqTodo)(v2)(v.value0);
                  })(v1)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof HandleNewTask) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Array.snoc(v1)(v.value0.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          throw new Error("Failed pattern match at TodoList line 47, column 12 - line 55, column 14: " + [ v.constructor.name ]);
      };
  ...
  exports["FinishedTodo"] = FinishedTodo;
  exports["HandleNewTask"] = HandleNewTask;
  exports["todoList"] = todoList;
})(PS["TodoList"] = PS["TodoList"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var Prelude = PS["Prelude"];
  var TodoList = PS["TodoList"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(TodoList.todoList(Effect_Aff.applicativeAff))(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();