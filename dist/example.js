...
(function(exports) {
  ...
  var PageInfo = (function () {
      function PageInfo(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      PageInfo.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new PageInfo(value0, value1, value2);
              };
          };
      };
      return PageInfo;
  ...
  var ProfilePage = (function () {
      function ProfilePage(value0) {
          this.value0 = value0;
      };
      ProfilePage.create = function (value0) {
          return new ProfilePage(value0);
      };
      return ProfilePage;
  })();
  var ArticlePage = (function () {
      function ArticlePage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ArticlePage.create = function (value0) {
          return function (value1) {
              return new ArticlePage(value0, value1);
          };
      };
      return ArticlePage;
  })();
  var renderF = function (page) {
      return function (v) {
          var v1 = (function () {
              if (page instanceof HomePage) {
                  return new PageInfo("Home Page!", "#login", "Go Login!");
              };
              if (page instanceof LoginPage) {
                  return new PageInfo("Login Page!", "#profile/1", "View a Profile!");
              };
              if (page instanceof ProfilePage) {
                  return new PageInfo("Profile for: " + Data_Show.show(Data_Show.showInt)(page.value0), "#blog/articles/1/hellothere", "See an Article!");
              };
              if (page instanceof ArticlePage) {
                  return new PageInfo("Article " + (page.value1 + (" by: " + Data_Show.show(Data_Show.showInt)(page.value0))), "#home", "Go Home!");
              };
              throw new Error("Failed pattern match at NavComponents line 59, column 36 - line 65, column 1: " + [ page.constructor.name ]);
          })();
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text(v1.value0) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(v1.value1) ])([ Halogen_HTML_Core.text(v1.value2) ]) ]);
      };
  };
  var $$eval = function (v) {
      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
  };
  var homeComponent = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](0),
      render: renderF(HomePage.value),
      "eval": $$eval,
      receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  });
  var loginComponent = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](0),
      render: renderF(LoginPage.value),
      "eval": $$eval,
      receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  });
  var profileComponent = function (uid) {
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](0),
          render: renderF(new ProfilePage(uid)),
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  };
  var articleComponent = function (uid) {
      return function (aid) {
          return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
              initialState: Data_Function["const"](0),
              render: renderF(new ArticlePage(uid, aid)),
              "eval": $$eval,
              receiver: Data_Function["const"](Data_Maybe.Nothing.value)
          });
      };
  ...
  exports["renderF"] = renderF;
})(PS["NavComponents"] = PS["NavComponents"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var NavComponents = PS["NavComponents"];
  var Prelude = PS["Prelude"];                 
  var HomeSlot = (function () {
      function HomeSlot() {

      };
      HomeSlot.value = new HomeSlot();
      return HomeSlot;
  })();
  var LoginSlot = (function () {
      function LoginSlot() {

      };
      LoginSlot.value = new LoginSlot();
      return LoginSlot;
  })();
  var ProfileSlot = (function () {
      function ProfileSlot() {

      };
      ProfileSlot.value = new ProfileSlot();
      return ProfileSlot;
  })();
  var ArticleSlot = (function () {
      function ArticleSlot() {

      };
      ArticleSlot.value = new ArticleSlot();
      return ArticleSlot;
  })();
  var ChangePage = (function () {
      function ChangePage(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangePage.create = function (value0) {
          return function (value1) {
              return new ChangePage(value0, value1);
          };
      };
      return ChangePage;
  })();
  var HandleAppAction = (function () {
      function HandleAppAction(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleAppAction.create = function (value0) {
          return function (value1) {
              return new HandleAppAction(value0, value1);
          };
      };
      return HandleAppAction;
  })();
  var slotForPage = function (v) {
      if (v instanceof NavComponents.HomePage) {
          return HomeSlot.value;
      };
      if (v instanceof NavComponents.LoginPage) {
          return LoginSlot.value;
      };
      if (v instanceof NavComponents.ProfilePage) {
          return ProfileSlot.value;
      };
      if (v instanceof NavComponents.ArticlePage) {
          return ArticleSlot.value;
      };
      throw new Error("Failed pattern match at Parent line 58, column 1 - line 58, column 30: " + [ v.constructor.name ]);
  };
  var slotEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof HomeSlot && y instanceof HomeSlot) {
              return true;
          };
          if (x instanceof LoginSlot && y instanceof LoginSlot) {
              return true;
          };
          if (x instanceof ProfileSlot && y instanceof ProfileSlot) {
              return true;
          };
          if (x instanceof ArticleSlot && y instanceof ArticleSlot) {
              return true;
          };
          return false;
      };
  });
  var slotOrd = new Data_Ord.Ord(function () {
      return slotEq;
  }, function (x) {
      return function (y) {
          if (x instanceof HomeSlot && y instanceof HomeSlot) {
          ...
          if (x instanceof HomeSlot) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof HomeSlot) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof LoginSlot && y instanceof LoginSlot) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof LoginSlot) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof LoginSlot) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof ProfileSlot && y instanceof ProfileSlot) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof ProfileSlot) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof ProfileSlot) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof ArticleSlot && y instanceof ArticleSlot) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Parent line 24, column 8 - line 24, column 38: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var nextPage = function (v) {
      if (v instanceof NavComponents.HomePage) {
          return NavComponents.LoginPage.value;
      };
      if (v instanceof NavComponents.LoginPage) {
          return new NavComponents.ProfilePage(1);
      };
      if (v instanceof NavComponents.ProfilePage) {
          return new NavComponents.ArticlePage(1, "Hello");
      };
      if (v instanceof NavComponents.ArticlePage) {
          return NavComponents.HomePage.value;
      };
      throw new Error("Failed pattern match at Parent line 52, column 1 - line 52, column 25: " + [ v.constructor.name ]);
  };
  var initialState = {
      currentPage: NavComponents.HomePage.value
  };
  var $$eval = function (v) {
      if (v instanceof ChangePage) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
              currentPage: v.value0
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      if (v instanceof HandleAppAction) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
      };
      throw new Error("Failed pattern match at Parent line 45, column 8 - line 50, column 14: " + [ v.constructor.name ]);
  };
  var componentForPage = function (v) {
      if (v instanceof NavComponents.HomePage) {
          return NavComponents.homeComponent;
      };
      if (v instanceof NavComponents.LoginPage) {
          return NavComponents.loginComponent;
      };
      if (v instanceof NavComponents.ProfilePage) {
          return NavComponents.profileComponent(v.value0);
      };
      if (v instanceof NavComponents.ArticlePage) {
          return NavComponents.articleComponent(v.value0)(v.value1);
      };
      throw new Error("Failed pattern match at Parent line 64, column 1 - line 64, column 79: " + [ v.constructor.name ]);
  };
  var render = function (st) {
      var sl = slotForPage(st.currentPage);
      var next = nextPage(st.currentPage);
      var comp = componentForPage(st.currentPage);
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ChangePage.create(next))) ])([ Halogen_HTML_Core.text("Next") ]), Halogen_HTML.slot(sl)(comp)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleAppAction.create)) ]);
  };
  var parentComponent = function (dictApplicative) {
      return Halogen_Component.parentComponent(slotOrd)({
  ...
  exports["HandleAppAction"] = HandleAppAction;
  exports["initialState"] = initialState;
  exports["HomeSlot"] = HomeSlot;
  exports["LoginSlot"] = LoginSlot;
  exports["ProfileSlot"] = ProfileSlot;
  exports["ArticleSlot"] = ArticleSlot;
  exports["parentComponent"] = parentComponent;
  exports["render"] = render;
  exports["nextPage"] = nextPage;
  exports["slotForPage"] = slotForPage;
  exports["componentForPage"] = componentForPage;
  exports["slotEq"] = slotEq;
  exports["slotOrd"] = slotOrd;
})(PS["Parent"] = PS["Parent"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
...
(function(exports) {
  ...
  var matchProfile = Data_Functor.map(Routing_Match.matchFunctor)(NavComponents.ProfilePage.create)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match.lit("profile"))(Routing_Match["int"]));
  var matchLogin = Data_Functor.voidRight(Routing_Match.matchFunctor)(NavComponents.LoginPage.value)(Routing_Match.lit("login"));
  var matchHome = Data_Functor.voidRight(Routing_Match.matchFunctor)(NavComponents.HomePage.value)(Routing_Match.lit("home"));
  var matchArticle = Control_Apply.apply(Routing_Match.matchApply)(Data_Functor.map(Routing_Match.matchFunctor)(NavComponents.ArticlePage.create)(Control_Apply.applySecond(Routing_Match.matchApply)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match.lit("blog"))(Routing_Match.lit("articles")))(Routing_Match["int"])))(Routing_Match.str);
  var router = Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(matchHome)(matchLogin))(matchProfile))(matchArticle);
  exports["router"] = router;
  exports["matchHome"] = matchHome;
...
(function(exports) {
  ...
  var hashChangeProducer = Control_Coroutine_Aff.produce(function (emitter) {
      return function __do() {
          var v = Web_Event_EventTarget.eventListener(function ($10) {
              return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Control_Coroutine_Aff.emit(emitter))(Web_HTML_Event_HashChangeEvent.fromEvent($10));
          })();
          return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(function __do() {
              var $11 = Web_HTML.window();
              return Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(v)(false)(Web_HTML_Window.toEventTarget($11))();
          })();
      };
  });
  var hashChangeConsumer = function (query) {
      return Control_Coroutine.consumer(Effect_Aff.monadAff)(function (event) {
          ...
          var result = Routing.match(Router.router)(hash);
          var newPage = (function () {
              ...
              throw new Error("Failed pattern match at Main line 48, column 17 - line 50, column 37: " + [ result.constructor.name ]);
          })();
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffAff)(query(Halogen_Query.action(Parent.ChangePage.create(newPage))))))(function () {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Parent.parentComponent(Effect_Aff.applicativeAff))(Data_Unit.unit)(v))(function (v1) {
          return Control_Coroutine.runProcess(Effect_Aff.monadRecAff)(Control_Coroutine.connect(Effect_Aff.monadRecAff)(Effect_Aff.parallelAff)(hashChangeProducer)(hashChangeConsumer(v1.query)));
      });
  }));
